...
public class MCPDatabase extends SQLiteAssetHelper {
    ...
    public static Cursor search(String input, int mode) {
        ...
        boolean kuangxYonhOnly = config.getKuangYonOnly();
        boolean allowVariants = config.getAllowVariants();
        boolean toneInsensitive = config.getToneInsensitive();
        int cantoneseSystem = config.getCantoneseStyle();
